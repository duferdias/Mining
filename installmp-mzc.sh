...
if [ "$1" = ""  ] && [ "$2" = ""  ]
then
echo "		\033[41;1;37m Minerar MazaCoin com CPUMiner-OPT v3.8.0 via Stratum Proxy \033[0m"				
sleep
echo "\033[34mForma de uso:\033[0m"
echo "sudo sh $0 \033[31m IP ou Domínio\033[32m Carteira de MazaCoin\033[0m \n"
...
sleep 1
echo "\033[01;31m Minerar MazaCoin com CPUMiner-OPT v3.8.0 via Stratum Proxy  http://zpool.ca \033[0m \n"
sleep 1

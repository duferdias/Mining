...
# zpool.ca através de um servidor proxy.
...
if [ "$1" = ""  ] && [ "$2" = ""  ]
then
echo "		\033[41;1;37m Minerar Dogecoin com CPUMiner-OPT v3.8.0 via Stratum Proxy \033[0m"				
sleep
echo "\033[34mForma de uso:\033[0m"
echo "sudo sh $0 \033[31m IP ou Domínio\033[32m Carteira de Dogecoin\033[0m \n"
echo "\033[33mExemplo:\033[0m"
echo "sudo sh $0 \033[31m $IPdominio_exemplo\033[32m $carteira_exemplo\033[0m \n"
exit 0
fi

echo "		\033[41;1;37m Minerar Dogecoin com CPUMiner-OPT v3.8.0 via Stratum Proxy \033[0m"	
sleep 1
echo "DOMÍNIO E CARTEIRA CONFIGURADOS:\033[01;32m $ipdomain $wallet\033[0m"
sleep 1
echo "\033[01;31m Minerar Dogecoin com CPUMiner-OPT v3.8.0 via Stratum Proxy  http://zpool.ca \033 [0m \n"
sleep 1
...
sleep 3
echo "Acompanhe o status de sua mineração em: http://www.zpool.ca/?address=$wallet"
sleep 15
clear

echo "\033[37;41mAbrindo sessão, aguarde...\033[0m"
sleep 3
sudo screen -dmS zpoolsp ./cpuminer -a yescrypt -o stratum+tcp://$ipdomain:6233 -u $wallet
sleep 2
clear

echo "\033[37;41mSua mineração foi iniciada! Para visualizar o processo digite o comando abaixo:\033[01;0m \n"
echo "\033[37;41mCOMANDO [screen -x zpoolsp]\033[0m"
sleep 1

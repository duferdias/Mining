...
# Com o script "sproxy-doge" é possível instalar, configurar e executar
# o stratum proxy com o arquivo de configuração stratum-proxy-yescrypt
# para receber mineradores de DOGECOIN e redirecioná-los para a zpool.ca.
...
# Insere as variáveis
sed -i 's/XMY/DOGE/g' stratum-proxy-yescrypt.conf

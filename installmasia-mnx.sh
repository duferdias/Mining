...
sleep 1
echo "\033[01;31m Minerar Minexcoin com MxMiner v0.17a  http://asia.minexpool.nl \033[0m \n"
sleep 1
...
sleep 5
echo "Acompanhe o status de sua mineração em: http://asia.minexpool.nl/workers/$wallet"
sleep 10
clear

echo "\033[37;41mAbrindo sessão, aguarde...\033[0m"
sleep 3
sudo screen -dmS minexpool ./mxminer -l asia -u $wallet.$workerName -z -nf 
sleep 2
clear

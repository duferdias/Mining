...
# Com o script "sproxy-mzc" é possível instalar, configurar e executar
# o stratum proxy com o arquivo de configuração stratum-proxy-yescrypt
# para receber mineradores de MazaCoin e redirecioná-los para a zpool.ca.
...
# Insere as variáveis
sed -i 's/XMY/MZC/g' stratum-proxy-yescrypt.conf
